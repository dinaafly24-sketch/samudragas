...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validasi
    if (empty($nama) || empty($telepon) || empty($password) || empty($tanggal_lahir)) {
        ...
        if ($cek->num_rows > 0) {
            ...
            $query = "INSERT INTO pelanggan (nama, telepon, tanggal_lahir, password) 
                      VALUES ('$nama','$telepon','$tanggal_lahir','$pass_md5')";
...
<body class="d-flex align-items-center justify-content-center min-vh-100 py-4">
    ...
    <div class="box">
        ...
        <form method="POST">
            ...
            <input class="inp" type="text" name="nama"
            ...
            <p class="note">Digunakan untuk verifikasi jika lupa password.</p>
            ...
            <input class="inp" type="password" name="konfirm"
                placeholder="Ulangi password" required>

            <button class="btn-daftar" type="submit">Buat Akun</button>
        </form>
